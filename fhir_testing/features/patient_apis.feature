...
Scenario: Create a new patient
    ...
    And has status code 201
    And the patient created has family name "Foo" and given name "Bar" 
...
Scenario: Delete a patient
    ...
    Then the server response has json key "error"
    And has status code 405